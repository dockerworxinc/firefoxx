FROM ubuntu:17.10
MAINTAINER Dockerworx <anand@dockerworx.com>
...
RUN curl  -L https://winswitch.org/gpg.asc | apt-key add -
RUN echo "deb http://winswitch.org/ artful main" > /etc/apt/sources.list.d/winswitch.list;
